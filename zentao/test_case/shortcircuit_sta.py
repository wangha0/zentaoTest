...
class ShortCircuitTest(myunit.MyTest):
    ...
    def test_shortcircuit1(self):
        ...
        readfilepath="E:/zentao/zentao/data/"+filename+'.csv'
        writefilepath='E:/zentao/zentao/data/'+filename+'result.csv'
        configfilepath='E:/zentao/zentao/data/'+filename+'config.xls'
